...
namespace ToDoList
{
    public class ToDoListShould
    {
        ...
        {
            list.AddEntry(42, userA, "ToDo thing", 100);
            list.MarkDone(42, userA, 101);
            list.RemoveEntry(42, userA, 102);
            list.AddEntry(42, userA, "ToDo thing", 103);
            
            AssertEntries(Entry.Done(42, "ToDo thing"));
        }
        ...
        public void Mark_Undone_When_Timestamps_Match()
        {
            list.AddEntry(42, userA, "ToDo thing", 100);
            list.MarkDone(42, userA, 101);
            list.MarkUndone(42, userA, 101);

            AssertEntries(Entry.Undone(42, "ToDo thing"));
        }

        [Test]
        public void Allow_Undone2()
        {
            list.AddEntry(42, userA, "ToDo thing", 100);
            list.MarkUndone(42, userB, 102);
            list.MarkDone(42, userA,  101);
            list.DismissUser(userB);
            list.AllowUser(userB);
